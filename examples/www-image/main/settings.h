...
#define ESP_WIFI_PASSWORD "***REMOVED***"
...
//#define IMG_URL ("http://192.168.0.100:1880/image")
#define IMG_URL ("http://192.168.0.100:9080/index.php?id=big&action=renderjpg")
